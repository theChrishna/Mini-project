...
def main():
    ...
    label = "E"  # Change this to "B", "C", etc. before running
    ...
    if not os.path.exists(file_name):
        with open(file_name, "w", newline="") as f:
            ...
            header = (
                ["label"]
                + [f"pt{i}_x" for i in range(21)]
                + [f"pt{i}_y" for i in range(21)]
            )
    ...
    while True:
        ...
        if len(lmList) != 0:
            ...
            if key & 0xFF == ord("s"):
                ...
                cv2.putText(
                    img, "SAVED!", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2
                )
